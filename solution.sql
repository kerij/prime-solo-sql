...
UPDATE syntax_practice SET account_balance = 10 WHERE transactions_attempted = 0 AND transactions_completed = 0;
...
-- 8. Add a new record.
INSERT INTO syntax_practice("username", "city", "transactions_completed", "transactions_attempted", "account_balance") VALUES ('keri', 'rosemount', '1', '1', '100');
